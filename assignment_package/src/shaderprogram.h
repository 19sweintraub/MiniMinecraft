...
public:
    ...
    int attrUV;  // A handle for the "in" vec2 representing uv coordinates
    int attrAnimCos; // A handle for the "in" boolean flag to determine if a texture should be animated
...
public:
    ...
    virtual void draw(Drawable &d, int textureSlot);
    void draw(Drawable &d); // Chris added this for the sky
